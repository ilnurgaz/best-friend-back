...
//nothing important
mongoose
    .connect('mongodb+srv://admin:admin@user.gzaauiq.mongodb.net/Mishka?retryWrites=true&w=majority&appName=User')
...
app.use(cors({
  origin: [
    'http://localhost:8081',             
    'https://best-friend-front.vercel.app' 
  ],
...
const job = new cron.CronJob('*/10 * * * *', () => {
    axios.get('https://bestfriend-back.onrender.com/')
        .then(response => {
